<template>
  ...
  <section class="top-section">
    <div class="nav-cards">
      <div class="nav-card">
        ...
        <el-button type="primary" @click="gotoPage('load')">进入页面</el-button>
      </div>
      ...
      <div class="nav-card">
        ...
        <el-button type="success" @click="gotoPage('elec')">进入页面</el-button>
      </div>
      ...
      <div class="nav-card">
        ...
        <el-button type="danger" @click="gotoPage('light')">进入页面</el-button>
      </div>
      <div class="nav-card">
        <div class="icon">
        ...
        <el-button type="danger" @click="showComingSoon">进入页面</el-button>
      </div>
      <div class="nav-card">
        <div class="icon">
  ...
  >
    <div class="dialog-content">
      ...
      <p>
        如有项目对接需求，请联系{{
          isTrina ? "李经理:15919159383" : "徐博士：18679510800"
        }}
      </p>
