<template>
  <div class="config-form card border-0 shadow-sm p-3 h-100">
    ...
    <div class="mb-3">
      ...
      >
        <el-option
          label="D-4 -> D+1、D+2、D+3【注：4天前用电量 → 预测未来3天分时负荷】"
          value="D-4"
        />
        <el-option
          label="D-3 -> D+1、D+2、D+3【注：3天前用电量 → 预测未来3天分时负荷】"
          value="D-3"
        />
        <el-option
          label="D-2 -> D+1、D+2、D+3【注：2天前用电量 → 预测未来3天分时负荷】"
          value="D-2"
        />
        <el-option
          label="D-1 -> D+1、D+2、D+3【注：1天前用电量 → 预测未来3天分时负荷】"
          value="D-1"
        />
      </el-select>
    </div>
...
.config-form {
  ...
  border-radius: 6px;
  .tip-card {
    background: linear-gradient(135deg, #f0f7ff 0%, #e6f3ff 50%, #f0f7ff 100%);
