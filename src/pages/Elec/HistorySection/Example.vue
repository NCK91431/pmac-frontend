<template>
  <div class="load-compare-container">
    <!-- 产品广告 -->
    <div class="product-advertisement" v-if="!isTrina">
        ...
        <div class="product-content">
          <div class="content-wrapper">
            <div class="title-section">
              ...
              <h3 class="product-title">EGate10-PV 光伏四可控制器</h3>
            </div>
            ...
            <div class="features-grid">
              <div class="feature-item">
                ...
                <div class="feature-content">
                  ...
                  <span class="feature-subtitle">多协议兼容</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                ...
                <div class="feature-content">
                  ...
                  <span class="feature-subtitle">数据加密</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                ...
                <div class="feature-content">
                  ...
                  <span class="feature-subtitle">即插即用</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
    ...
    <div class="card info-card">
      <div class="card-header header-section">
        ...
        <div class="weather-selector">
          <div class="btn-group" role="group" aria-label="天气案例选择">
            <button
              type="button"
    ...
    <div class="content-section">
      ...
      <!-- 数据展示 -->
      <div v-if="!loading && !error && compareData" class="data-container">
        <!-- 对比图表 -->
        <div class="card mb-4">
          <div
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="city-selector mb-4">
                  ...
                  >
                    <el-option
                      v-for="(city, index) in compareData.cityWeatherForecast"
                      :key="index"
                      :label="city.location"
                      :value="index"
                    />
...
const selectedCityWeather = computed(() => {
  if (!compareData.value || !compareData.value.cityWeatherForecast) return null;
  return compareData.value.cityWeatherForecast[selectedCityIndex.value] || null;
});
